...
class InletterView(ttk.Frame):
    ...
    def setup_ui(self):
        ...
        self.ent_rec = ttk.Entry(frame, width=30)
        ...
        ttk.Label(frame, text="Attachment:").grid(row=10, column=0, sticky="w", padx=10, pady=5)
        ttk.Button(frame, text="Browse...", command=self.browse).grid(row=10, column=1, sticky="w", padx=10, pady=5)
        self.lbl_file = ttk.Label(frame, text="No file attached")
        self.lbl_file.grid(row=10, column=1, padx=120, pady=5)
